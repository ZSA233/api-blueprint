...
def _validate_swift_sources(swift_dir: Path) -> None:
    ...
    narrow = (swift_dir / "Narrow/Sources/SwiftNarrowEntrypoint/main.swift").read_text(encoding="utf-8")
    haystack = "\n".join(
        (runtime, runtime_errors, types, demo_api, demo_types, binary, transport, aggregate, runtime_root, narrow)
    )
    required_snippets = (
        ...
        "apiHTTPEventStreamBridge",
        "apiHTTPWebSocketBridge",
