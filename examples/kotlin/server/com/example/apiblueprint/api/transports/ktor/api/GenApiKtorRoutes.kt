...
private val HTTP_ROUTE_API_API_CHANNEL_WS = HttpRouteInfo(
...
public fun Route.registerApiRoutes(
    ...
    webSocket("/api/ws") {
        val channel = KtorWebSocketChannel(
            session = this,
            clientMessageSerializer = HelloChannelMessage.serializer(),
            serverMessageSerializer = HelloChannelMessage.serializer(),
            closeSerializer = DefaultConnectionClose.serializer(),
            config = config,
        )
