...
private val HTTP_ROUTE_API_DEMO_GET_ABC = HttpRouteInfo(
...
private val HTTP_ROUTE_API_DEMO_POST_TESTPOST = HttpRouteInfo(
    request = HttpRequestInfo(
        binaryContentEncodings = emptySet(),
    ),
    response = HttpResponseInfo(
...
private val HTTP_ROUTE_API_DEMO_POST_FORMSUBMIT = HttpRouteInfo(
    request = HttpRequestInfo(
        binaryContentEncodings = emptySet(),
    ),
    response = HttpResponseInfo(
...
private val HTTP_ROUTE_API_DEMO_GET_REQUESTOPTIONS = HttpRouteInfo(
    request = HttpRequestInfo(
        binaryContentEncodings = emptySet(),
    ),
    response = HttpResponseInfo(
...
private val HTTP_ROUTE_API_DEMO_DELETE_DELETE = HttpRouteInfo(
    request = HttpRequestInfo(
        binaryContentEncodings = emptySet(),
    ),
    response = HttpResponseInfo(
...
private val HTTP_ROUTE_API_DEMO_STREAM_SWEEPEVENTS = HttpRouteInfo(
    request = HttpRequestInfo(
        binaryContentEncodings = emptySet(),
    ),
    response = HttpResponseInfo(
...
private val HTTP_ROUTE_API_DEMO_CHANNEL_ASSISTANTSESSION = HttpRouteInfo(
    request = HttpRequestInfo(
        binaryContentEncodings = emptySet(),
    ),
    response = HttpResponseInfo(
...
private val HTTP_ROUTE_API_DEMO_POST_POSTDEPRECATED = HttpRouteInfo(
    request = HttpRequestInfo(
        binaryContentEncodings = emptySet(),
    ),
    response = HttpResponseInfo(
...
private val HTTP_ROUTE_API_DEMO_POST_RAW = HttpRouteInfo(
    request = HttpRequestInfo(
        binaryContentEncodings = emptySet(),
    ),
    response = HttpResponseInfo(
...
private val HTTP_ROUTE_API_DEMO_POST_MAPMODEL = HttpRouteInfo(
    request = HttpRequestInfo(
        binaryContentEncodings = emptySet(),
    ),
    response = HttpResponseInfo(
...
private val HTTP_ROUTE_API_DEMO_GET_ERRORDEMO = HttpRouteInfo(
    request = HttpRequestInfo(
        binaryContentEncodings = emptySet(),
    ),
    response = HttpResponseInfo(
