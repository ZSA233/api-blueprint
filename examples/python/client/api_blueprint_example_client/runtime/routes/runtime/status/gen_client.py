...
class StatusClient:
    ...
    async def runtime_current_status(
        self,
        *,
        headers: Mapping[str, str] | None = None,
        timeout: float | None = None,
    ) -> RuntimeCurrentStatusResponse:
        response_type: str | None = 'RuntimeCurrentStatusResponse'
        payload = await self._transport.request(
            ApiRequest(
                method="GET",
                path="/runtime/status/current",
                route_id="runtime.status.get.current",
        ...
        return RuntimeCurrentStatusResponse.from_value(payload, "runtime_current_status.response")
