...
const WAILS_V3_BINDINGS: Record<string, string> = {"hello.HelloService.Greet": "example.com/api-blueprint/wails-hello/golang/views/transports/wailsv3/api/hello.HelloService.Greet"};
