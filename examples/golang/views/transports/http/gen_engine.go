...
func GET[Q, B, P any](
	...
	engine.GET(relativePath, makeHandler[Q, B, P](executor, rawResponse))
}
...
func POST[Q, B, P any](
	...
	engine.POST(relativePath, makeHandler[Q, B, P](executor, rawResponse))
}
...
func PUT[Q, B, P any](
	...
	engine.PUT(relativePath, makeHandler[Q, B, P](executor, rawResponse))
}
...
func DELETE[Q, B, P any](
	...
	engine.DELETE(relativePath, makeHandler[Q, B, P](executor, rawResponse))
}
...
func WS[Q, B, P any](
	...
	engine.GET(relativePath, makeWSHandler[Q, B, P](executor))
}
