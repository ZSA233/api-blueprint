...
const (
	RoomService_RoomList_FullMethodName = "/example.api.legacy.room.RoomService/RoomList"
)
...
func (c *roomServiceClient) RoomList(ctx context.Context, in *RoomListRequest, opts ...grpc.CallOption) (*RoomListResponse, error) {
...
func (UnimplementedRoomServiceServer) RoomList(context.Context, *RoomListRequest) (*RoomListResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RoomList not implemented")
}
...
func _RoomService_RoomList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoomServiceServer).RoomList(ctx, req.(*RoomListRequest))
	}
...
var RoomService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "example.api.legacy.room.RoomService",
