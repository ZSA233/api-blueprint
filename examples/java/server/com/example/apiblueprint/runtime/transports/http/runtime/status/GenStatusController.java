...
package com.example.apiblueprint.runtime.transports.http.runtime.status;

import com.fasterxml.jackson.annotation.JsonProperty;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.example.apiblueprint.runtime.routes.runtime.status.StatusService;
import com.example.apiblueprint.runtime.routes.runtime.status.GenStatusServiceStub;
import com.example.apiblueprint.runtime.routes.runtime.status.GenStatusTypes;
import com.example.apiblueprint.runtime.transports.http.GenSpringServerConfig;
import com.example.apiblueprint.runtime.runtime.GenApiError;
import com.example.apiblueprint.runtime.runtime.GenApiErrorEntry;
import com.example.apiblueprint.runtime.runtime.GenApiErrorPayload;
import com.example.apiblueprint.runtime.runtime.GenApiErrors;
...
import com.example.apiblueprint.runtime.runtime.GenApiToastPayload;
...
public class GenStatusController {
    ...
    private static final HttpRouteInfo HTTP_ROUTE_RUNTIME_STATUS_GET_CURRENT = new HttpRouteInfo(
    ...
    public GenStatusController(
        @Autowired(required = false) StatusService service,
        ObjectMapper objectMapper,
        @Autowired(required = false) GenSpringServerConfig serverConfig,
        @Autowired(required = false) Executor connectionExecutor
    ) {
        this.service = service == null ? new GenStatusServiceStub() : service;
    ...
    public Object runtimeCurrentStatus(
        @RequestParam Map<String, String> queryParams
    ) throws Exception {
        try {
            Object result = service.runtimeCurrentStatus(
            );
            ...
            return wrapApiErrorResponse(GenApiResponseEnvelope.of("CodeMessageDataEnvelope", "code_message_data", "nested", 0, "ok", new GenApiResponseEnvelope.Fields("code", "message", "data", "error", "ok")), error, "runtime.status.get.current");
        }
    }
