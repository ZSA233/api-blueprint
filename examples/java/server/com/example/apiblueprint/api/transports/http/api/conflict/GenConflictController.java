...
public class GenConflictController {
    ...
    private static final HttpRouteInfo HTTP_ROUTE_API_CONFLICT_GET_DEFAULT = new HttpRouteInfo(
    ...
    public Object defaultValue(
        ...
        try {
            ...
            return wrapApiErrorResponse(GenApiResponseEnvelope.of("CodeMessageDataEnvelope", "code_message_data", "nested", 0, "ok", new GenApiResponseEnvelope.Fields("code", "message", "data", "error", "ok")), error, "api.conflict.get.default");
        }
    }
