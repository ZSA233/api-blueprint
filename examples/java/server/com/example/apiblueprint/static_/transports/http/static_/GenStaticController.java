...
import com.example.apiblueprint.static_.transports.http.GenSpringServerConfig;
...
public class GenStaticController {
    ...
    private static final HttpRouteInfo HTTP_ROUTE_STATIC_STATIC_GET_DOCJSON = new HttpRouteInfo(
    ...
    private static final HttpRouteInfo HTTP_ROUTE_STATIC_STATIC_GET_DOCHAHA = new HttpRouteInfo(
        new HttpRequestInfo(Set.of()),
        new HttpResponseInfo(
            "json",
            "application/json",
