...
package com.example.apiblueprint.legacy.transports.http.legacy.account;

import com.fasterxml.jackson.annotation.JsonProperty;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.example.apiblueprint.legacy.routes.legacy.account.AccountService;
import com.example.apiblueprint.legacy.routes.legacy.account.GenAccountServiceStub;
import com.example.apiblueprint.legacy.routes.legacy.account.GenAccountTypes;
...
public class GenAccountController {
    ...
    private static final HttpRouteInfo HTTP_ROUTE_LEGACY_ACCOUNT_GET_PROFILE = new HttpRouteInfo(
    ...
    public GenAccountController(
        @Autowired(required = false) AccountService service,
        ObjectMapper objectMapper,
        @Autowired(required = false) GenSpringServerConfig serverConfig,
        @Autowired(required = false) Executor connectionExecutor
    ) {
        this.service = service == null ? new GenAccountServiceStub() : service;
    ...
    public Object accountProfile(
        ...
        try {
            Object result = service.accountProfile(
            );
            ...
            return wrapApiErrorResponse(GenApiResponseEnvelope.of("CodeMessageDataEnvelope", "code_message_data", "nested", 0, "ok", new GenApiResponseEnvelope.Fields("code", "message", "data", "error", "ok")), error, "legacy.account.get.profile");
        }
    }
