...
package com.example.apiblueprint.legacy.transports.http.legacy.room;

import com.fasterxml.jackson.annotation.JsonProperty;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.example.apiblueprint.legacy.routes.legacy.room.RoomService;
import com.example.apiblueprint.legacy.routes.legacy.room.GenRoomServiceStub;
import com.example.apiblueprint.legacy.routes.legacy.room.GenRoomTypes;
...
public class GenRoomController {
    ...
    private static final HttpRouteInfo HTTP_ROUTE_LEGACY_ROOM_GET_LIST = new HttpRouteInfo(
    ...
    public GenRoomController(
        @Autowired(required = false) RoomService service,
        ObjectMapper objectMapper,
        @Autowired(required = false) GenSpringServerConfig serverConfig,
        @Autowired(required = false) Executor connectionExecutor
    ) {
        this.service = service == null ? new GenRoomServiceStub() : service;
    ...
    public Object roomList(
        ...
        try {
            Object result = service.roomList(
            );
            ...
            return wrapApiErrorResponse(GenApiResponseEnvelope.of("CodeMessageDataEnvelope", "code_message_data", "nested", 0, "ok", new GenApiResponseEnvelope.Fields("code", "message", "data", "error", "ok")), error, "legacy.room.get.list");
        }
    }
