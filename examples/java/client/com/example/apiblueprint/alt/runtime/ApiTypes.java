...
public final class ApiTypes {
    ...
    public record ApiDemoA(
        ...
        @JsonProperty("lmnop") List<ApiTypes.ApiDemoSubA> lmnop,
        @JsonProperty("enum_color") ApiTypes.ColorEnum enumColor,
        @JsonProperty("enum_status") ApiTypes.StatusEnum enumStatus,
        @JsonProperty("enum_list") List<ApiTypes.StatusEnum> enumList
    ) {
    }
    ...
    public record ApiDemoSubA(
        ...
        @JsonProperty("amap") List<ApiTypes.ApiDemoMap> amap
    ) {
    }
