...
def _artifact_for_route(
    ...
    if kind == "go-server":
        ...
        files = [
            ...
            _join(root_base, "routes", route_path, "controllers", f"Gen{pascal_group}Controller.java"),
            _join(root_base, "routes", route_path, "delegates", f"Gen{pascal_group}Delegate.java"),
            _join(root_base, "routes", route_path, "types", f"Gen{pascal_group}Types.java"),
            _join(root_base, "routes", route_path, "adapters", f"Gen{pascal_group}Adapters.java"),
            _join(root_base, "spring", "GenSpringRequestContext.java"),
            _join(root_base, "spring", "GenSpringRequestBinder.java"),
            _join(root_base, "spring", "GenSpringResponseWriter.java"),
            _join(root_base, "spring", "GenSpringMvcContractAssertions.java"),
        ]
        if package:
            imports = [
                f"{package}.{root}.routes.{kotlin_route_package}.controllers.Gen{pascal_group}Controller",
                f"{package}.{root}.routes.{kotlin_route_package}.delegates.Gen{pascal_group}Delegate",
                f"{package}.{root}.routes.{kotlin_route_package}.types.Gen{pascal_group}Types",
                f"{package}.{root}.routes.{kotlin_route_package}.adapters.Gen{pascal_group}Adapters",
