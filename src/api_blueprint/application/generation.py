...
from api_blueprint.config import ResolvedConfig, ResolvedGrpcJobConfig, resolve_config


def _require_golang_config(resolved: ResolvedConfig):
...
def _require_typescript_config(resolved: ResolvedConfig):
...
def _require_grpc_config(resolved: ResolvedConfig):
